...
final Uri openCloseApi = Uri.parse(baseUrl + 'shop_open_close');
...
const String GSTAmount = 'gst_service_charge_amount';
const String ExtraDelCharge = 'extra_delivery_charge';
...
const String BreakfastStartTime = 'breakfast_start_product_time';
const String BreakfastEndTime = 'breakfast_end_product_time';
const String LunchStartTme = 'lunch_start_product_time';
const String LunchEndTime = 'lunch_end_product_time';
const String DinnerStartTime = 'dinner_start_product_time';
const String DinnerEndTime = 'dinner_end_product_time';
const String PackageCharge = 'packing_charge';
