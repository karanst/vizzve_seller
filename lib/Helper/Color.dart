...
const Color primary =Color(0xffAFCB1F);
const Color secondary = Color(0xffAFCB1F);
const Color fontColor = Colors.black;
const Color grad1Color = Color(0xffAFCB1F);
const Color grad2Color = Color(0xffAFCB1F);
