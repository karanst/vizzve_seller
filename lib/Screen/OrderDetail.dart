...
//========================= getDeliveryBoy API =================================
          ...
          if (!error) {
            ...
            if (data.length != 0) {
              ...
              for (int i = 0; i < tempList[0].itemList!.length; i++){
                String? orderItemId;
                orderItemId = tempList[0].itemList![i].id;
  ...
  Future<void> delboyDialog(String status) async {
    //int itemindex = index;
    await showDialog(
        context: context,
                ...
                new ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    if (form.validate()) {
                      ...
                      updateOrder(
                          curSelected, updateOrderItemApi, item, );
                    }
                  },
                ),
              ],
                      ...
                      children: [
                        Text("GST & Service Charges" + " " + ":",
                            style: Theme.of(context).textTheme.button!.copyWith(
                                color: lightBlack2)),
                        Text("+ " + CUR_CURRENCY + tempList[0].gstAmount!,
                            style: Theme.of(context).textTheme.button!.copyWith(
                                color: lightBlack2))
                      ],
                    ),
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(getTranslated(context, 'EXTRA_DELIVERY_CHARGE')! + " " + ":",
                            style: Theme.of(context).textTheme.button!.copyWith(
                                color: lightBlack2)),
                        Text("+ " + CUR_CURRENCY + " " + tempList[0].extraDelCharge!,
                            style: Theme.of(context).textTheme.button!.copyWith(
                                color: lightBlack2))
                      ],
                    ),
  ...
  confirmOrder(OrderItem orderItem){
     ...
     child:  Padding(
       ...
       child: Column(
         children: [
           ...
           Row(
             children: [
               tempList[0].itemList![0].status!="received" ? Container():
               Expanded(
           ...
           Text("Call Admin for any cancel of any Order or Help"),
           //delPermission == '1'
    tempList[0].itemList![0].status =="received" ? Container():
                Padding(
             padding:
                           ...
                           children: [
                             Expanded(
                               child: Text(
                                 index1 != -1
                                     ?
                                 delBoyList[index1].name.toString()
                                // orderItem.deliverBy!
                                // model!.itemList![0].deliverBy!
                                     : getTranslated(
                                   context,
                                   "SELECTDELBOY",
                                 )!,
...
//                         Column(
//                           children: [
//                             tempList[0].itemList![i].status!="received" ? Container():
//                             Row(
//                               children: [
//                                 Expanded(
//                                     child: ElevatedButton(
