...
import 'package:eshopmultivendor/Model/CategoryModel/SubCategoryModel.dart';
...
//                        Parameter For API Call
  ...
  String? packageCharges; //pro_input_name
  String? breakfastStart; //pro_input_name
  String? breakfastEnd; //pro_input_name
  String? lunchStart; //pro_input_name
  String? lunchEnd;//pro_input_name
  String? dinnerStart;//pro_input_name
  String? dinnerEnd;//pro_input_name
...
//======================= TextEditingController ================================
  ...
  TextEditingController breakfastStartTime = TextEditingController();
  TextEditingController breakfastEndTime = TextEditingController();
  TextEditingController lunchStartTime = TextEditingController();
  TextEditingController lunchEndTime = TextEditingController();
  TextEditingController dinnerStartTime = TextEditingController();
  TextEditingController dinnerEndTime = TextEditingController();
  TextEditingController packagingCharges = TextEditingController();
...
//======================= Delete this  ================================
  ...
  var isFreeFood = false;

  String isFreeFoods = "0";
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Expanded(child: Text("Select Category", style: TextStyle(
                fontWeight: FontWeight.bold,
                fontSize: 14
              ),)),
              Expanded(
                child: FutureBuilder<CategoryModel?>(
                    ...
                    builder: (BuildContext context, AsyncSnapshot snapshot) {
                      if (snapshot.hasData) {
                        ...
                        List cat =
                            snapshot.data.data.map((i) => i.name).toList();
                        List catId =
                            snapshot.data.data.map((i) => i.id).toList();
                        return SizedBox(
                          height: 40,
                          child: DropdownSearch<dynamic>(
                              ...
                              onChanged: (value) {
                                setState(() {
                                  sendCatId = catId[cat.indexOf(value)];
                                });
                              }),
                        );
          ...
          sendCatId != null
              ? Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Expanded(child: Text("Select Sub Category", style: TextStyle(
                      fontSize: 14,
                      fontWeight: FontWeight.bold
                    ),)),
                    Expanded(
                      child: FutureBuilder<SubCategoryModel?>(
                          future: getSubCat(sendCatId),
                          builder:
                              (BuildContext context, AsyncSnapshot snapshot) {
                            if (snapshot.hasData) {
                              subCat = snapshot.data.data
                                  .map((i) => i.name)
                                  .toList();
                              subCatId =
                                  snapshot.data.data.map((i) => i.id).toList();
                              return SizedBox(
                                ...
                                child: DropdownSearch<dynamic>(
                                  ...
                                  popupItemDisabled: (dynamic s) =>
                                      s.startsWith('I'),
                                  selectedItem:subCat.isNotEmpty? subCat[0] :"No Item",
                                  onChanged: (value) {
                                    setState(() {
                                      sendSubCatId =
                                          subCatId[subCat.indexOf(value)];
                                    });
                                  },
                                ),
                              );
        ...
        Row(
          ...
          children: [
            Padding(
              ...
              child: Text("Breakfast Start Time",
                style: TextStyle(
                    fontSize: 14,
                    color: black,
                    fontWeight: FontWeight.bold
      ...
      children: [
        ...
        Container(
          ...
          child: TextFormField(
            ...
            controller: packagingCharges,
            textInputAction: TextInputAction.next,
            inputFormatters: [FilteringTextInputFormatter.singleLineFormatter],
            onChanged: (value) {
              packageCharges = value;
            },
            // validator: (val) => validateProduct(val, context),
            decoration: InputDecoration(
              hintText: "Add Package Charges",
              hintStyle: Theme.of(this.context).textTheme.subtitle2!.copyWith(
                color: Colors.grey[600],
                fontWeight: FontWeight.normal,
              ),
  ...
  Future<void> addProductAPI(List<String> attributesValuesIds) async {
    ...
    if (_isNetworkAvail) {
      try {
        ...
        request.fields["recommend_products"] = isRecommend;
        request.fields["free_food_delivery"] = isFreeFoods;
        ...
        request.fields[CategoryId] = sendCatId!;
        //todo new_cat_id, sub_category_id
        request.fields["new_cat_id"] = sendCatId;
        request.fields["sub_category_id"] = sendSubCatId;
        request.fields[BreakfastStartTime] = breakfastStartTime.text;
        request.fields[BreakfastEndTime] = breakfastEndTime.text;
        request.fields[LunchStartTme] = lunchStartTime.text;
        request.fields[LunchEndTime] = lunchEndTime.text;
        request.fields[DinnerStartTime] = dinnerStartTime.text;
        request.fields[DinnerEndTime] = dinnerEndTime.text;
        request.fields[PackageCharge] = packageCharges!;
        //attribute_values
        // this is complecated
  ...
  bool validateAndSave() {
    ...
    if (form.validate()) {
      if (productType == null) {
        ...
        return false;
      } else if (sendSubCatId == null && sendCatId == null) {
